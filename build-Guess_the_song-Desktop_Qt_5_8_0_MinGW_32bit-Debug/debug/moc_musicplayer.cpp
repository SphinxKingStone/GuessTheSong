...
#include "../../Guess_the_song/musicplayer.h"
...
QT_MOC_LITERAL(4, 27, 4), // "gogo"
QT_MOC_LITERAL(5, 32, 7), // "new_one"
QT_MOC_LITERAL(6, 40, 4) // "dtdt"

    },
    "MusicPlayer\0finished\0\0name\0gogo\0new_one\0"
    "dtdt"
};
...
void MusicPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->finished((*reinterpret_cast< QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 1: { int _r = _t->gogo();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 2: _t->new_one((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef int (MusicPlayer::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MusicPlayer::finished)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MusicPlayer::gogo)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
int MusicPlayer::finished(QString _t1)
{
    int _t0 = int();
